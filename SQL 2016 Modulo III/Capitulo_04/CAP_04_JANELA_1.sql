/*
	...
	INTENT (IS, IU, IX): 
        ...
        SCHEMA (Sch-M, Sch-S): 
            	...
            	.Evita que uma tabela que está sendo utilizada em produção seja alterada 
...
-- Consultar bloqueios
-- Observe a coluna RESOURCE_TYPE e veja que o bloqueio ocorreu através
...
-- o bloqueio ocorreu através da chave primária
SELECT 
  L.RESOURCE_TYPE, L.REQUEST_MODE, L.REQUEST_TYPE, L.REQUEST_STATUS, 
  D.NAME AS BANCO_DADOS, O.NAME NOME_OBJETO, O2.NAME NOME_OBJETO_RELAC
FROM SYS.DM_TRAN_LOCKS L JOIN SYS.DATABASES D ON L.RESOURCE_DATABASE_ID = D.DATABASE_ID
...
-- Observe o recurso bloqueado (KEY): Bloqueio de linha através da chave primária
SELECT 
  L.RESOURCE_TYPE, L.REQUEST_MODE, L.REQUEST_TYPE, L.REQUEST_STATUS, 
  D.NAME AS BANCO_DADOS, O.NAME NOME_OBJETO, O2.NAME NOME_OBJETO_RELAC
FROM SYS.DM_TRAN_LOCKS L JOIN SYS.DATABASES D ON L.RESOURCE_DATABASE_ID = D.DATABASE_ID
...
-- vá até a janela 2 e execute o EXEMPLO 3...
--
-- Descartar alterações
ROLLBACK
...
-- Observe o recurso bloqueado e o nome do objeto (OBJECT, PEDIDOS): 
-- BOM  -> Menor número de bloqueios, menos processamento, menor quantidade de memória utilizada
-- RUIM -> Menor concorrência. São bloqueados mais registros do que o necessário
SELECT 
  L.RESOURCE_TYPE, L.REQUEST_MODE, L.REQUEST_TYPE, L.REQUEST_STATUS, 
...
-- Este tipo de isolamento impede que a transação atual
