...
IF EXISTS(SELECT * FROM Master.dbo.Sysdatabases
                    WHERE Name LIKE '%Comercio%')
         DROP DATABASE Comercio
go
CREATE DATABASE Comercio
ON PRIMARY
(
  name  =  'Comercio_Dados1',
  filename   =  'C:\Bancos\Comercio_Dados1.mdf',
  size = 5MB,
  maxsize= 10MB,
  filegrowth = 1MB
),
FILEGROUP TABELAS
(
  name  =  'Comercio_Dados2',
  filename   =  'C:\Bancos\Comercio_Dados2.ndf',
  size = 10MB,
  maxsize= 100MB,
  filegrowth = 10MB
),
FILEGROUP INDICES
(
  name  =  'Comercio_Dados3',
  filename   =  'C:\Bancos\Comercio_Dados3.ndf',
  size = 10MB,
  maxsize= 100MB,
  filegrowth = 10MB
)
...
(
  name  =  'Comercio_Log',
  filename   =  'C:\Bancos\Comercio_Log.ldf',
  size = 1MB,
  maxsize= 10MB,
  filegrowth = 1MB
)
